    ...
    def install_system():
        with open("./files/log.txt", "r+") as file:
            install_commands = {
                ...
                "Copy script": "cp -f ./files/scp.sh /mnt/etc",
                "Copy arch-dark": "cp -rf ./files/Arch-Dark /mnt/etc",
                "Copy lxdm": "cp -f ./files/lxdm.conf /mnt/etc",
                "Copy Info": "cp -f ./files/info.txt /mnt/etc",
                "Copy theme-grub": "cp -rf ./files/Xenlism-Arch /mnt/etc",
                "Copy Log": "cp -f ./files/log.txt /mnt/etc",
                "Copy evdev": "cp -rf ./files/xorg.conf.d /mnt/etc",
